(function (angular) {
    "use strict";
    angular.module("FileManagerApp").service("apiHandler", [
        "$http",
        "$q",
        "$window",
        "$translate",
        ...
        function (
            ...
            ApiHandler.prototype.deferredHandler = function (
                data,
                deferred,
                code,
                defaultMsg
                    ...
                    .then(
                        ...
                        function (response) {
                            self.deferredHandler(
                                ...
                                deferred,
                                response.status,
                                $translate.instant("error_moving")
                            );
                        }
                    )
                    ["finally"](function () {
            ...
            ApiHandler.prototype.download = function (
                apiUrl,
                itemPath,
                toFilename,
                downloadByAjax,
                    ...
                    .then(
                        ...
                        function (response) {
                            self.deferredHandler(
                                ...
                                deferred,
                                response.status,
                                $translate.instant("error_downloading")
                            );
                        }
                    )
                    ["finally"](function () {
            ...
            ApiHandler.prototype.downloadMultiple = function (
                apiUrl,
                items,
                toFilename,
                downloadByAjax,
            ...
            ApiHandler.prototype.compress = function (
                apiUrl,
                items,
                compressedFilename,
                path
            ...
            ApiHandler.prototype.extract = function (
                apiUrl,
                item,
                folderName,
                path
            ...
            ApiHandler.prototype.changePermissions = function (
                apiUrl,
                items,
                permsOctal,
                permsCode,
